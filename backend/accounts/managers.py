...
class CustomUserManager(BaseUserManager):
    ...
    def create_user(self, email, first_name, role, last_name=None, password=None, **extra_fields):
        if not email:
    ...
    def create_superuser(self, email, first_name, role, last_name=None, password=None, **extra_fields):
        ...
        user = self.create_user(clean_email, first_name, last_name, role, password, **extra_fields)
        user.save()
        return user